...
public final class ColorUtils {
    ...
    private ColorUtils() { throw new UnsupportedOperationException("Utility class"); }
    ...
    public static String stripColors(String message) {
        ...
        try {
            ...
            return sanitized.replaceAll("&[0-9a-frlomnk]", "");
        }
    }
    ...
    public static Component parseComponent(String message) {
        ...
        try {
            ...
            String sanitized = removeAngleBrackets(message);
            component = Component.text(sanitized);
        }
    ...
    private static final Pattern BUKKIT_HEX = Pattern.compile("(?i)&x(?:&([0-9a-f]))(?:&([0-9a-f]))(?:&([0-9a-f]))(?:&([0-9a-f]))(?:&([0-9a-f]))(?:&([0-9a-f]))");
    ...
    private static String expandGradientAliases(String s) {
        ...
        while (i < s.length()) {
            ...
            if (ch == '<') {
                ...
                if (close == -1) { out.append(s.substring(i)); break; }
