...
public class LanguageManagerImpl implements LanguageManager {
    ...
    private final ConcurrentHashMap<String, String> playerLanguagesCache;
    ...
    public CompletableFuture<String[]> getSupportedLanguages() {
        return CompletableFuture.completedFuture(pluginConfig.getSupportedLanguages().toArray(new String[0]));
    }
    ...
    public CompletableFuture<String> getLanguageDisplayName(String language) {
        try {
            Map<String, String> displayNames = pluginConfig.getLanguageDisplayNames();
